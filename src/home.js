        ...
        <div class="mb-12 lg:mb-0">
          <div class="rounded-lg shadow-lg h-full block bg-white">
            ...
            <div class="p-6">
              ...
              <p>
              Nous répondrons avec plaisir et sans jugement à toute question quel que soit votre niveau de connaissances, et nous vous conseillerons sur le service vers lequel vous tourner.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="mb-12 lg:mb-0">
          <div class="rounded-lg shadow-lg h-full block bg-white">
            ...
            <div class="p-6">
              ...
              <p>
              Un service personnalisé cinq étoiles, voici à quoi vous attendre lorsque vous traitez avec SoClean Esthétique.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="">
          <div class="rounded-lg shadow-lg h-full block bg-white">
            ...
            <div class="p-6">
              ...
              <p>
               Avec SoClean, les bonnes questions seront posées pour un estimé a la hauteur de vos ambitions.
              </p>
            </div>
          </div>
        </div>
